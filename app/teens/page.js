...
export default function TeensPage() {
    const [activeCategory, setActiveCategory] = useState('Teens');
    ...
    const mainCategories = [
        ...
        { name: 'Teens', icon: CircleUser, color: 'text-white', bg: 'bg-[#8B5CF6]', border: 'border-transparent', active: true },
    ];

    // Main Subcategory Pills (Teens specific from screenshot)
    ...
    const products = [
        { id: 1, image: womenn, discount: '-27%', name: 'Teen Outfit 1', saveAmt: 'Save ৳210', hasFreeDelivery: true, hasSlider: true },
        { id: 2, image: womenn, discount: '-17%', name: 'Teen Outfit 2', saveAmt: 'Save ৳100', hasFreeDelivery: false, hasSlider: true },
        { id: 3, image: polo1, discount: '-27%', name: 'Teen Outfit 3', saveAmt: 'Save ৳100', hasFreeDelivery: false, hasSlider: true },
        { id: 4, image: pic1, discount: '-13%', name: 'Teen Outfit 4', saveAmt: 'Save ৳100', hasFreeDelivery: false, hasSlider: false },
    ];
                ...
                <div className="p-4 lg:p-6 lg:pl-6">
                    ...
                    <div className="flex flex-wrap gap-x-2.5 gap-y-3.5 mb-8 w-fit max-w-[90%]">
                        {subcategoryPills.map((sub, idx) => (
                            <button
                                key={idx}
                                className="flex items-center gap-1.5 px-4 py-1.5 bg-white border border-gray-200 rounded-full hover:border-[#8B5CF6] hover:shadow-sm transition-all group"
                            >
                                <span className="text-[14px] font-semibold text-gray-500 group-hover:text-[#8B5CF6]">{sub.name}</span>
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <div className="flex items-center bg-gray-100 rounded-md px-3 py-1.5 border border-gray-200">
                            <span className="text-[14px] font-semibold text-[#4A4B57] mr-3">Teens</span>
                                ...
                                <div className="relative w-full aspect-3/4 bg-gray-100 overflow-hidden rounded-md">
                                    ...
                                    {product.hasSlider && (
                                        <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 flex gap-1 z-10">
                                            ...
                                            <div className="w-2 h-2 rounded-full bg-black/30 shadow-sm"></div>
                                        </div>
                                    )}

                                    {/* Free Delivery Banner */}
                                    {product.hasFreeDelivery && (
                                        <div className="absolute bottom-0 left-0 z-10 bg-[#00A97E] text-white text-[11px] font-bold px-2.5 py-1.5 rounded-tr-md flex items-center gap-1">
