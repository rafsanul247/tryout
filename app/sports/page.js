...
export default function SportsPage() {
    ...
    // Main Category Pills (All inactive in Sports page overview)
    ...
    // Products (from screenshot, rendering titles as they appear)
    const products = [
        { id: 1, image: polo1, discount: '-24%', name: 'Mens Premium Sports Active Wear Full Sleeve T-shirt-...', saveAmt: 'Save ৳210' },
        { id: 2, image: polo2, discount: '-24%', name: 'Mens Premium Sports Active Wear T-shirt- Agility', saveAmt: 'Save ৳100' },
        { id: 3, image: pic1, discount: '-24%', name: 'Mens Premium Sports Active Wear T-shirt - Kick Off', saveAmt: 'Save ৳100' },
        { id: 4, image: polo1, discount: '-24%', name: 'Mens Premium Sports Active Wear T-shirt - Vigorous', saveAmt: 'Save ৳100' },
    ];
                ...
                <div className="p-4 lg:p-6 lg:pl-6">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <div className="flex items-center bg-gray-100 rounded-md px-3 py-1.5 border border-gray-200">
                            <span className="text-[14px] font-semibold text-[#4A4B57] mr-3">Sports</span>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
                        {[...products, ...products].map((product, index) => (
                            <div key={index} className="group cursor-pointer relative flex flex-col overflow-hidden rounded-md border border-gray-200 hover:shadow-lg transition-all duration-300 bg-white shadow-sm pb-3">
                                {/* Discount Badge */}
